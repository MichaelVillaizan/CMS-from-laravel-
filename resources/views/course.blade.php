...
@section('content')
    <div class="grid grid-cols-3 gap-4">
        ...
        <div class="teaxt-gray-700 col-span-2 ">
            <img src="{{$course->image}}" alt="portada curso">
            <h2 class="text-4xl">{{$course->name}}</h2>
            <p>{{$course->description}}</p>
            <div class="flex mt-3">
                <img src="{{$course->user->avatar}}" alt="" class="h-10 w-10 rounded-full mr-2">
                <div>
                    <p class="text-gray-700 text-sm">{{$course->user->name}}</p>
    ...
    <div class="text-center mt-4">
        ...
        <h2 class="text-xl text-gray-600">Formate Online como porfesional en tecnologia</h2>
    </div>
